...
part.active  // the cell under the nozzle`,
    api: [
      ...
      { name: "VoxelShape", type: '"sphere" | "block" | "pyramid" | "gear" | "vessel" | "lattice"', description: "Six fields chosen to stay legible at low resolutions and to stress the sampler differently: curvature, a chamfer, stepping, angular teeth with a bore, a hollow interior, and a cubic strut lattice." },
    ],
    notes: [
...
<RobotGripper interactive onOpeningChange={setOpening} />`,
    ...
    notes: ["A supplied opening always wins and stops the loop. Uncontrolled, the jaws work a pick cycle, parked by a reduced-motion preference.", "The drawing exposes an accessible name with its opening percentage. Override aria-label for application-specific context."],
  },
  {
